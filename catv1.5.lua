...
wait(0.01)
Chat("c￴￴a￴￴￴t￴￴￴b￴￴y￴p￴as￴s￴e￴r|L￴￴o￴￴aded!")

local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()

local Window = Fluent:CreateWindow({
    Title = "catbypasser v1.5",
...
Tabs.Main:AddButton({
   Title = "Auto bypasser",
   Description = "Executes the auto bypasser",
   Callback = function()
      local function sendChat(msg)
         ...
         if tagged then
             game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Tag Detected!", Text = "Message got tagged!"})
         else
     ...
     -- Send a message as soon as the script is executed
     sendChat("j￴o￴i￴nd￴i￴s￴c￴o￴r￴d￴.￴g￴g￴/￴c￴a￴t￴b￴y￴p￴a￴s￴s￴e￴r")
     ...
     G2L["2"].BackgroundColor3 = Color3.fromRGB(1, 1, 1)
     G2L["2"].Size = UDim2.new(0, 460, 0, 280)
     G2L["2"].Position = UDim2.new(0.5, -150, 0.5, -50)
     G2L["2"].BorderColor3 = Color3.fromRGB(1, 1, 1)
     G2L["3"] = Instance.new("LocalScript", G2L["2"])
     G2L["3"].Name = "Drag"
     G2L["4"] = Instance.new("UICorner", G2L["2"])
     G2L["4"].CornerRadius = UDim.new(5, 4)
     G2L["5"] = Instance.new("ImageLabel", G2L["2"])
     G2L["5"].BorderSizePixel = 0
     G2L["5"].BackgroundColor3 = Color3.fromRGB(1, 1, 1)
     G2L["5"].Image = "rbxassetid://112546652009650"
     G2L["5"].Size = UDim2.new(0, 460, 0, 280)
     G2L["5"].BorderColor3 = Color3.fromRGB(0, 0, 0)
     G2L["5"].LayoutOrder = -6
     G2L["6"] = Instance.new("UICorner", G2L["5"])
     G2L["6"].CornerRadius = UDim.new(0, 4)
     G2L["7"] = Instance.new("TextBox", G2L["5"])
     G2L["7"].PlaceholderColor3 = Color3.fromRGB(1, 1, 1)
     ...
     G2L["7"].PlaceholderText = "Message here!"
     G2L["7"].Size = UDim2.new(0.905, -20, 0.33938, -10)
     G2L["7"].Position = UDim2.new(0, 34, 0, 60)
     G2L["7"].Text = ""
     G2L["7"].LayoutOrder = 8
     G2L["7"].BackgroundTransparency = 0.6
     G2L["8"] = Instance.new("UICorner", G2L["7"])
     G2L["8"].CornerRadius = UDim.new(5, 4)
     G2L["9"] = Instance.new("TextButton", G2L["5"])
     G2L["9"].TextWrapped = true
     G2L["9"].BorderSizePixel = 0
     G2L["9"].TextSize = 30
     G2L["9"].BackgroundColor3 = Color3.fromRGB(240,128,128)
     G2L["9"].FontFace = Font.new("rbxasset://fonts/families/FredokaOne.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
     G2L["9"].Size = UDim2.new(0.5, -17, 0.2, -10)
     G2L["9"].BackgroundTransparency = 0.5
     G2L["9"].LayoutOrder = 5
     G2L["9"].Text = "Send!"
     G2L["9"].Position = UDim2.new(0.24, 10, 0.71938, 0)
     G2L["a"] = Instance.new("LocalScript", G2L["9"])
     G2L["b"] = Instance.new("UICorner", G2L["9"])
     G2L["b"].CornerRadius = UDim.new(5, 6)
     G2L["c"] = Instance.new("LocalScript", G2L["9"])
     G2L["c"].Enabled = false
     G2L["c"].Disabled = true
     G2L["d"] = Instance.new("TextLabel", G2L["5"])
     G2L["d"].TextWrapped = true
     G2L["d"].TextStrokeTransparency = 0.83
     G2L["d"].BorderSizePixel = 0
     G2L["d"].TextScaled = true
     G2L["d"].BackgroundColor3 = Color3.fromRGB(128,0,0)
     G2L["d"].TextSize = 19
     G2L["d"].FontFace = Font.new("rbxasset://fonts/families/FredokaOne.json")
     G2L["d"].TextColor3 = Color3.fromRGB(1,1,1)
     G2L["d"].BackgroundTransparency = 1
     G2L["d"].Size = UDim2.new(0, 460, 0, 34)
     G2L["d"].BorderColor3 = Color3.fromRGB(0, 0, 0)
     G2L["d"].Text = "Catbypasser Auto"
     ...
     G2L["f"].Size = UDim2.new(0.1, -10, 0.1, -10)
     G2L["f"].BackgroundTransparency = 1
     G2L["f"].LayoutOrder = 6
     G2L["f"].Text = "X"
     G2L["f"].Position = UDim2.new(1, 0, 0.03, 0)
     G2L["f"].AnchorPoint = Vector2.new(1, 0)
     G2L["f"].TextColor3 = Color3.fromRGB(255, 0, 0)
     G2L["f"].ZIndex = 10
     G2L["g"] = Instance.new("UICorner", G2L["f"])
     G2L["g"].CornerRadius = UDim.new(0, 3)
     ...
     local function C_a()
         ...
         local function sendChat(msg)
             ...
             local tagged = filteredMessage ~= msg
             if tagged then
                 showNotification("Tag Detected!", "Message got tagged!")
                 textBox.Text = ""
             else
                 if TextChatService.ChatVersion == Enum.ChatVersion.LegacyChatService then
                     ReplicatedStorage:FindFirstChild("DefaultChatSystemChatEvents").SayMessageRequest:FireServer(msg, "All")
     ...
     G2L["f"].MouseButton1Click:Connect(closeGUI)
            ...
            Tabs.Sentences:AddButton({
                ...
                Callback = function()
                   Chat("wow!thatс￴￴￴ос￴￴￴kridingneverstops!")
                    ...
                    Tabs.Sentences:AddButton({
                        Title = "keep riding that d￴￴￴іс￴￴￴k baby!",
                        Description = "Very important button",
                        Callback = function()
...
Tabs.Sentences:AddButton({
                                             Title = "s￴h￴u￴ty￴￴ourf￴￴u￴￴c￴￴k￴￴i￴￴n￴￴gm￴ou￴t￴hf￴￴a￴￴t￴￴b￴￴i￴￴t￴￴c￴￴h￴",
                                             Description = "Very important button",
                                             Callback = function()
                                                Chat("￴￴￴s￴h￴u￴ty￴￴ourf￴￴u￴￴c￴￴k￴￴i￴￴n￴￴gm￴ou￴t￴hf￴￴a￴￴t￴￴b￴￴i￴￴t￴￴c￴￴h")
